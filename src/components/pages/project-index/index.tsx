                ...
                <div className="card-body justify-between p-2 pt-0 border-t">
                    ...
                    <div className="card-actions justify-end join gap-0">
                        <button className="join-item btn btn-sm px-2" onClick={(e) => onDownloadProject(project, e)}>
                            <svg className="w-4 h-4 rounded-none dark:fill-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <svg className="w-4 h-4 rounded-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
