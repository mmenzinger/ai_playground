...
//             const visibility = shadowRoot.getElementById(
//                 'projectId'
//             ) as HTMLSelectElement;
//             name.value = '';
...
//                     'name'
//                 ) as HTMLInputElement;
//                 const type = shadowRoot.getElementById(
//                     'type'
//                 ) as HTMLSelectElement;
...
//         content: html` <li>
//             <p>
//                 Are you sure you want to <em>permanently</em> delete the
//                 <em>${type}</em> file '${file.name}'?
//             </p>
//         </li>`,
//     };
// }
